...
import { GER_DOMESTIC_1997_SQUADS } from './curated-ger-domestic-1997.js';
import {
...
// Domestic mid-tier of the late-90s Bundesliga (M12 shortlist supply) — real
// squad players at the non-elite clubs so options lists read like a real
// shortlist. Shared by the dortmund-1997 and bayern-1998 worlds.
for (const [club, seeds] of Object.entries(GER_DOMESTIC_1997_SQUADS)) {
  BUNDESLIGA_1997_SQUADS[club] = [...(BUNDESLIGA_1997_SQUADS[club] ?? []), ...seeds];
}
