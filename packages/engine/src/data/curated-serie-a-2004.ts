...
import { ITA_DOMESTIC_2004_SQUADS } from './curated-ita-domestic-2004.js';
...
// Domestic mid-tier of the 2004-05 Serie A (M12 shortlist supply) — real squad
// players at the non-elite clubs so options lists read like a real shortlist.
for (const [club, seeds] of Object.entries(ITA_DOMESTIC_2004_SQUADS)) {
  INTER_2004_SQUADS[club] = [...(INTER_2004_SQUADS[club] ?? []), ...seeds];
}
