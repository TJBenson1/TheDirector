...
function p(
  ...
  personality: Trait,
  extra: { latentCeiling?: number; archetype?: string } = {},
): CuratedSeed {
  return {
    id: `cur_${id}`,
    name,
...
export const MILAN_1999: CuratedSeed[] = [
  q('milan', 'maldini', 'Paolo Maldini', 1968, 'Italy', ['LB', 'CB'], 89, 90, 2005, 25, t(10, 6, 8, 10, 2, 6), {
    loyalty: 99, archetype: 'ball-playing-cb',
...
export const LIVERPOOL_1999: CuratedSeed[] = [
  ...
  q('liverpool', 'owen', 'Michael Owen', 1979, 'England', ['ST'], 87, 90, 2005, 68, t(8, 6, 8, 6, 4, 7), { archetype: 'poacher' }),
];
...
export const PSV_1999: CuratedSeed[] = [
  q('psv', 'ruud', 'Ruud van Nistelrooy', 1976, 'Netherlands', ['ST'], 85, 90, 2004, 60, t(8, 6, 9, 6, 4, 7), { archetype: 'poacher' }),
];
...
export const SPORTING_1999: CuratedSeed[] = [
  q('sporting', 'cristiano', 'Cristiano Ronaldo', 1985, 'Portugal', ['RW', 'LW', 'ST'], 66, 94, 2003, 15, t(10, 8, 10, 5, 3, 9), { archetype: 'inside-forward' }),
];
...
export const MIDFIELD_POOL_1999: Array<[ClubId, CuratedSeed]> = [
  ...
  ['real_madrid', q('real_madrid', 'redondo', 'Fernando Redondo', 1969, 'Argentina', ['DM', 'CM'], 86, 86, 2002, 30, t(8, 5, 7, 6, 3, 7), { archetype: 'deep-playmaker' })],
...
export const ERA_1999_POOL: Array<[ClubId, CuratedSeed]> = [
  ...
  ['real_madrid', q('real_madrid', 'roberto_carlos', 'Roberto Carlos', 1973, 'Brazil', ['LB'], 87, 87, 2004, 25, t(8, 6, 8, 7, 4, 7), { archetype: 'full-back-attacking' })],
  ['barcelona', q('barcelona', 'deboer', 'Frank de Boer', 1970, 'Netherlands', ['CB'], 84, 84, 2003, 25, t(8, 5, 7, 6, 3, 7))],
  ['lazio', q('lazio', 'nesta', 'Alessandro Nesta', 1976, 'Italy', ['CB'], 87, 90, 2005, 30, t(9, 5, 8, 9, 3, 7), { archetype: 'covering-cb' })],
  ...
  ['barcelona', q('barcelona', 'figo', 'Luís Figo', 1972, 'Portugal', ['RW', 'AM'], 88, 89, 2003, 25, t(8, 7, 8, 5, 4, 7), { archetype: 'crosser' })],
  ...
  // ── Forwards ──
  ['real_madrid', q('real_madrid', 'raul', 'Raúl', 1977, 'Spain', ['ST', 'AM'], 88, 90, 2004, 25, t(9, 6, 9, 10, 3, 7), { archetype: 'poacher' })],
  ['juventus', q('juventus', 'delpiero', 'Alessandro Del Piero', 1974, 'Italy', ['ST', 'AM'], 88, 89, 2004, 35, t(8, 7, 8, 9, 4, 7))],
  ['juventus', q('juventus', 'inzaghi', 'Filippo Inzaghi', 1973, 'Italy', ['ST'], 84, 85, 2003, 30, t(7, 6, 8, 6, 5, 6), { archetype: 'poacher' })],
  ...
  ['inter', q('inter', 'vieri', 'Christian Vieri', 1973, 'Italy', ['ST'], 87, 88, 2004, 45, t(6, 8, 8, 5, 7, 6), { archetype: 'target-man' })],
...
export const BARCELONA_1999: CuratedSeed[] = [
  ...
  q('barcelona', 'puyol', 'Carles Puyol', 1978, 'Spain', ['CB', 'RB'], 68, 88, 2005, 20, t(10, 4, 9, 10, 4, 7), { archetype: 'covering-cb' }),
  ...
  q('barcelona', 'xavi', 'Xavi', 1980, 'Spain', ['CM'], 66, 90, 2005, 15, t(10, 4, 9, 10, 3, 8), { archetype: 'deep-playmaker' }),
