...
export const SCENARIOS: Record<ScenarioId, ScenarioSeed> = {
  ...
  'inter-1998': {
    ...
    contextExtra: [
      ...
      { id: 'psv', name: 'PSV Eindhoven', prestige: 74 },
      { id: 'feyenoord', name: 'Feyenoord', prestige: 70 },
      { id: 'benfica', name: 'Benfica', prestige: 72 },
      { id: 'celtic', name: 'Celtic', prestige: 72 },
      { id: 'rangers', name: 'Rangers', prestige: 72 },
    ],
  ...
  'milan-2007': {
    ...
    contextExtra: [
      ...
      // European selling clubs (M12A rollout) — the mid-2000s foreign pipeline.
      { id: 'lyon', name: 'Olympique Lyonnais', prestige: 82 },
      { id: 'hamburg', name: 'Hamburger SV', prestige: 74 },
      { id: 'werder', name: 'Werder Bremen', prestige: 76 },
      { id: 'benfica', name: 'Benfica', prestige: 76 },
  ...
  'inter-2004': {
    ...
    contextExtra: [
      ...
      { id: 'lyon', name: 'Olympique Lyonnais', prestige: 80 },
      { id: 'werder', name: 'Werder Bremen', prestige: 76 },
      { id: 'leverkusen', name: 'Bayer Leverkusen', prestige: 76 },
      { id: 'celtic', name: 'Celtic', prestige: 72 },
    ],
