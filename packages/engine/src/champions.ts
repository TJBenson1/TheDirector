...
const REAL_UCL: Record<string, Record<number, RealFinal>> = {
  ...
  'era-bundesliga-2009': {
    ...
    // home, and Real Madrid's dynasty follows. Atlético/PSG runners-up (not in the
    // reused pack) resolve to the field.
    2009: { w: 'inter', r: 'bayern' },
    2010: { w: 'barcelona', r: 'man_utd' },
    2011: { w: 'chelsea', r: 'bayern' },
    2012: { w: 'bayern', r: 'dortmund' },
  ...
  'era-bundesliga-2012': {
    // Klopp's peak Dortmund and Heynckes's treble Bayern, 2012→2025. The all-German
    // 2013 final (Bayern beat Dortmund) opens it, then Real Madrid's dynasty; every
    // real winner's club is in the pack, Atlético's runners-up included.
    2012: { w: 'bayern', r: 'dortmund' },
