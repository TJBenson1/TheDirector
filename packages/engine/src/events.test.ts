...
describe('scripted beat-sheet packs (passive fidelity)', () => {
  ...
  const EXPECTED: Record<string, { min: number; until: number }> = {
    ...
    'liverpool-1995': { min: 13, until: 2002 },
    'arsenal-1996': { min: 13, until: 2004 },
    'chelsea-1996': { min: 13, until: 2004 },
    'dortmund-1997': { min: 13, until: 2003 },
    'bayern-1998': { min: 13, until: 2004 },
    'inter-1998': { min: 13, until: 2005 },
    'spurs-2001': { min: 12, until: 2008 },
    'inter-2004': { min: 13, until: 2011 },
    'juventus-2006': { min: 12, until: 2013 },
    'real-madrid-2006': { min: 13, until: 2013 },
    'milan-2007': { min: 12, until: 2013 },
    'bayern-2009': { min: 13, until: 2015 },
    'liverpool-2010': { min: 15, until: 2016 },
    'dortmund-2012': { min: 14, until: 2018 },
    'spurs-2013': { min: 12, until: 2020 },
    'man-utd-2013': { min: 14, until: 2020 },
    'barcelona-2014': { min: 14, until: 2021 },
  };
