...
const NEARMISS_1998: NearMissEntry[] = [
  ...
  nm({ reason: 'hijack', window: '2008-07', from: 'barcelona', almostTo: 'inter', realTo: 'milan', fee: 17_500_000, realFee: 17_500_000, id: 'ronaldinho_milan', name: 'Ronaldinho', birthYear: 1980, nationality: 'Brazil', positions: ['AM', 'LW'], ability: 81, ceiling: 91, proneness: 45, per: [4, 7, 6, 5, 6, 7], note: 'Moratti vowed Inter would "fight" for the Barça outcast, but Milan won the derby tug-of-war for €22m.' }),
];
...
const NEARMISS_1999_2014: NearMissEntry[] = [
  ...
  nm({ reason: 'hijack', window: '2003-07', from: 'psg', almostTo: 'real_madrid', realTo: 'barcelona', fee: 21_000_000, realFee: 21_000_000, id: 'ronaldinho_2003', name: 'Ronaldinho', birthYear: 1980, nationality: 'Brazil', positions: ['AM', 'LW'], ability: 82, ceiling: 90, proneness: 35, per: [5, 7, 7, 5, 6, 8], note: 'Florentino prioritised Beckham over Ronaldinho, so Laporta’s Barcelona swooped instead.' }),
  ...
  nm({ reason: 'player-choice', window: '2006-07', from: 'arsenal', almostTo: 'barcelona', realTo: null, fee: 16_100_000, realFee: 16_100_000, id: 'henry_2006', name: 'Thierry Henry', birthYear: 1977, nationality: 'France', positions: ['ST', 'LW'], ability: 88, ceiling: 89, proneness: 35, per: [7, 7, 8, 6, 5, 7], note: 'Chased by Barcelona after the 2006 final, Henry pledged loyalty and signed a new Arsenal deal before moving in 2007.' }),
  nm({ reason: 'hijack', window: '2012-08', from: 'athletic', almostTo: 'barcelona', realTo: 'bayern', fee: 30_000_000, realFee: 32_000_000, id: 'javimartinez_2012', name: 'Javi Martínez', birthYear: 1988, nationality: 'Spain', positions: ['DM', 'CB'], ability: 82, ceiling: 84, proneness: 30, per: [8, 5, 7, 7, 4, 7], note: 'Barcelona held talks but baulked at his €40m clause, and Bayern paid it in full.' }),
];
...
const NEARMISS_2009_NM: NearMissEntry[] = [
  ...
  nm({ reason: 'hijack', window: '2012-01', from: 'gladbach', almostTo: 'bayern', realTo: 'dortmund', fee: 14_000_000, realFee: 14_000_000, id: 'reus', name: 'Marco Reus', birthYear: 1989, nationality: 'Germany', positions: ['AM', 'LW'], ability: 82, ceiling: 87, proneness: 55, per: [7, 5, 7, 8, 3, 7], note: 'Bayern courted him, but Dortmund triggered his €17.1m clause and the boyhood BVB fan went home.' }),
