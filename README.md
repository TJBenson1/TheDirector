...
| M10 + data | ◻ | Reality-ledger execution + ambition overrides + Tier-2 (needs era `realTransferLedger` curation); academy; API/narrative layer; difficulty sliders; remaining scenarios/era packs. |
