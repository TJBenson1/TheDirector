...
| M8–M10 | ◻ | Rival AI (reality-default + ambition overrides + Tier-2), remaining internal friction (board/sacking, agents, manager autonomy, chemistry, succession, financial shocks), academy, full calibration + era data. |
