...
| M8 data / M9–M10 | ◻ | Reality-ledger execution (needs era `realTransferLedger` data) + ambition overrides + Tier-2; internal friction (board/sacking, agents, manager autonomy, chemistry, succession, financial shocks); academy; API/narrative layer; full calibration. |
